...
enum LanguageKey {
  ...
  L_WEB_PORTAL_START,
  L_JS_PORTAL_CONFIRM,
  // --- WebGUI restart button (1.0.7) ---
  L_WEB_RESTART,
  L_JS_RESTART_CONFIRM,
  L_JS_RESTARTING,
...
static const LanguageEntry LANGUAGE_TABLE[] = {
  ...
  {{"Neustart", "Restart", "Redémarrer", "Reiniciar", "Riavvia", "Перезапустить", "पुनः प्रारंभ", "重启"}},
  {{"InfoTerm wirklich neu starten?", "Really restart the InfoTerm?", "Vraiment redémarrer l'InfoTerm ?", "¿Reiniciar realmente el InfoTerm?", "Riavviare davvero l'InfoTerm?", "Действительно перезапустить InfoTerm?", "क्या वाकई InfoTerm को पुनः प्रारंभ करें?", "确定要重启 InfoTerm 吗？"}},
